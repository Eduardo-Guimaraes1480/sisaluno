        ...
        <form action="../php/vd-produto.php" method="post">
            ...
            <option value=""></option> <!-- Campo Vazio -->
                ...
                include '../database/conexao.php';
                        ...
                        $retorno = $conexao->prepare('SELECT CBarra, titulo, preco FROM produto');
                        $retorno->execute();

                        foreach($retorno->fetchAll() as $value) { ?>
                            <option value="<?php echo($value['CBarra'])?>" data-preco="<?php echo($value['preco'])?>"><?php echo($value['titulo'])?></option>
                        <?php } ?>
            </select><br>
            ...
            <option value=""></option> <!-- Campo Vazio -->
                <?php 
                    ...
                    <?php
                        ...
                        $retorno = $conexao->prepare('SELECT IDSuap_cliente, nome FROM clientes');
                        $retorno->execute();

                        foreach($retorno->fetchAll() as $value) { ?>
                            <option value="<?php echo($value['IDSuap_cliente'])?>"><?php echo($value['nome'])?></option>
                        <?php } ?>
            </select><br>
